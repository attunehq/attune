/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd895e9735ae489e2437682f4a6a8d9e)
// Runtime types generated with workerd@1.20250424.0 2025-04-28 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ATTUNE_DATABASE_URL: string;
		ATTUNE_R2_BUCKET: R2Bucket;
		ATTUNE_RDS_HYPERDRIVE: Hyperdrive;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATTUNE_DATABASE_URL">> {}
}
